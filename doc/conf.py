...
# -*- coding: utf-8 -*-
#
# ecephys documentation build configuration file, created by
...
latex_documents = [
  ('index', 'ecephys.tex', 'ecephys Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'ecephys', 'ecephys Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'ecephys', 'ecephys Documentation',
   'Ariel Rokem', 'ecephys', 'One line description of project.',
   'Miscellaneous'),
]
