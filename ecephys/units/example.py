...
cluster_info = cluster_info[cluster_info.cluster_id.isin(sorting.get_unit_ids())]  # All info for subselected clusters

# Get all the spike times for each cluster
all_spike_times = ecephys.units.get_spike_times_list(
    sorting, sorting.get_unit_ids()
)